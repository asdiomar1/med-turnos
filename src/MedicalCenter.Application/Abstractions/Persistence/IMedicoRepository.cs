...
public interface IMedicoRepository
{
    ...
    Task<Medico?> GetByMedicoUserIdAsync(Guid? medicoUserId, CancellationToken cancellationToken);
    ...
    Task<IReadOnlyCollection<Medico>> GetByMedicoUserIdsAsync(IEnumerable<Guid> medicoUserIds, CancellationToken cancellationToken);
